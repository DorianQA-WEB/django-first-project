...
class HomePageGetTests(SimpleTestCase):
    ...
    def test_url_name(self):
        self.assertEqual(self.response.resolver_match.view_name, 'blog:home')
    ...
    def test_content_title(self):
        self.assertContains(self.response, '<h1>Главная</h1>', html=True)
    ...
    def test_content_text(self):
        self.assertContains(self.response, f'&copy; mysite.com 2026-{timezone.now().year}. All rights reserved.')
